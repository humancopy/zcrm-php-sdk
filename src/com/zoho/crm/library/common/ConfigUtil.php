...
class ConfigUtil
{
	...
	{
		$currentUserEmail= RestClient::getCurrentUserEmailID();
		
		if ($currentUserEmail == null && self::getConfigValue("currentUserEmail") == null)
		{
			throw new Exception("Current user should either be set in RestClient or in configuration.properties file");
		}
