...
class Module
{
    ...
    /**
     * relatedList
     * @return ModuleRelatedList instance
     */
    ...
    /**
     * relatedList
     * @param ModuleRelatedList instance $relatedList
     * @return 
     */
    ...
    /**
     * Returns list of Fields of the module.
     * @return list of Fields of the module
     */
     ...
     * @return all Layouts of the module
     */
    ...
    {
    	$record = Record::getInstance($this->apiName, $entityId);
    ...
    public  function getTags() 
    {
        ...
        {
            throw new Exception("Module Api Name MUST NOT be null/empty for getTags operation");
        }
    ...
    public function getTagCount($tagid)
    {
        if($this->apiName == null || $this->apiName == "")
        {
            throw new Exception("Module Api Name MUST NOT be null/empty for getTagCount operation");
        }
        if ($tagid == null || $tagid == 0)
        {
            throw new Exception("Tag ID MUST NOT be null/empty for getTagCount operation");
        }
    ...
    public function createTags($tags)
    {
        if($this->apiName == null || $this->apiName == "")
        {
            throw new Exception("Module Api Name MUST NOT be null/empty for createTags operation");
        }
        if(sizeof($tags)<=0){
            throw new Exception("Tag object list MUST NOT be null/empty for createTags operation");
        }
    ...
    public function updateTags($tags)
    {
        if($this->apiName == null || $this->apiName == "")
        {
            throw new Exception("Module Api Name MUST NOT be null/empty for updateTags operation");
        }
        if(sizeof($tags)<=0){
            throw new Exception("Tag object list MUST NOT be null/empty for updateTags operation");
        }
    ...
    public function addTagsToRecords($recordIds, $tagNames)
    {
        if($this->apiName == null || $this->apiName == "")
        {
            throw new Exception("Module Api Name MUST NOT be null/empty for Add Tags to Multiple records operation");
        }
        if(sizeof($tagNames)<=0)
        {
            throw new Exception("Tag Name list MUST NOT be null/empty for Add Tags to Multiple records operation");
        }
        if(sizeof($recordIds)<=0)
        {
            throw new Exception("Record ID list MUST NOT be null/empty for Add Tags to Multiple records operation");
        }
    ...
    public function removeTagsFromRecords($recordIds, $tagNames)
    {
        if($this->apiName == null || $this->apiName == "")
        {
            throw new Exception("Module Api Name MUST NOT be null/empty for Remove Tags from Multiple records operation");
        }
        if(sizeof($tagNames)<=0)
        {
            throw new Exception("Tag Name list MUST NOT be null/empty for Remove Tags from Multiple records operation");
        }
        if(sizeof($recordIds)<=0)
        {
            throw new Exception("Record ID list MUST NOT be null/empty for Remove Tags from Multiple records operation");
        }
