...
class ModuleRelation
{
	...
	{
		if($parentModuleAPINameOrParentRecord instanceof Record)
		{
		...
		if($relatedListAPINameOrJunctionRecord instanceof JunctionRecord)
		{
	...
	{
		return new ModuleRelation($parentModuleAPINameOrParentRecord,$relatedListAPIName);
	}
